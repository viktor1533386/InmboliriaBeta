...
<div class="page-header">
  <div>
    <h2>➕ Nueva Zona</h2>
    <p>Agrega una nueva zona para agrupar propiedades y vendedores.</p>
  </div>
...
<div class="form-card">
  <form method="POST" data-validate>
        ...
        <div style="display:flex; flex-direction:column; gap:0.5rem; margin-top:0.5rem;">
          <?php foreach ($vendedores as $v): ?>
            <label style="font-weight:normal; cursor:pointer; display:flex; align-items:center; gap:0.5rem;">
              <input type="checkbox" name="vendedores_ids[]" value="<?= $v->id ?>" style="width:auto; margin:0;">
    ...
    <div class="form-actions" style="margin-top:2rem">
      <button type="submit" class="btn btn-primary" style="width:100%;font-size:1.1rem;padding:12px">Guardar Zona</button>
    </div>
